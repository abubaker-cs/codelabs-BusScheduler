...
import com.example.busschedule.database.viewmodels.BusScheduleViewModel
import com.example.busschedule.database.viewmodels.BusScheduleViewModelFactory
...
class StopScheduleFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Because scheduleForStopName() is a suspend function, it needs to be called from a coroutine.
